...
class ZhilianSpider(scrapy.Spider):
    ...
    def parse_company_detall(self,response):
        comapnyClassfiy = response.css('table.comTinyDes tr')[0].css('td::text()').extract_first('')
        response.xpath('//table[@class="comTinyDes"]/tr[1]/td[2]/span/text()').extract_first('')
